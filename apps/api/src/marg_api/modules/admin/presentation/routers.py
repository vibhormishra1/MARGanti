...
async def update_user(
    ...
    try:
        return await service.update_user(user_id, cmd, current_user.user_id, current_user.role, current_user.organization_id)
...
async def update_organization(
    ...
    try:
        return await service.update_organization(current_user.organization_id, cmd, current_user.user_id, current_user.role)
    except ValueError as e:
        raise HTTPException(status_code=400, detail=str(e))
